...
function plotData(table) {
    ...
    //     legend: 'none'
    //   };
    var chart = new google.visualization.ScatterChart(document.getElementById('jxgbox'));
    console.log(data)
    chart.draw(data);
}
...
//             window.alert(f.getTerm());// => doesn't work!
...
//                 f,
//                 {strokeWidth: 1, 
//                     strokeColor: table.fitLine.color, 
//                     highlight: false,
