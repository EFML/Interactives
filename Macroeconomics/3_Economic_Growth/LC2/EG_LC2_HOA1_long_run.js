...
function init() {
  ...
  // //Sliders
  // var slidery = brd1.create('slider',[[-1.75,2],[-1.75,7],[0.75,1.0,1.25]],{withLabel:false,snapWidth:0.01,
  //                                                                        color:'Crimson'});
  ...
  var semi = brd1.create('arc', [po, px, py],{strokeWidth:5,strokeColor:'DodgerBlue',highlight:false});

  var hA = brd1.create('segment',[[0.0,5.5],[10.0,5.5]],{visible:false});
