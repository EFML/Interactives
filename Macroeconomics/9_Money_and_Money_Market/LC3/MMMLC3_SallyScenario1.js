var Macro = (function(JXG, MacroLib) {
    ...
    function init() {
        ...
        var xaxis2 = brd2.create('axis', [[0, 0], [11, 0]], {withLabel: false});
        var yaxis2 = brd2.create('axis', [[0, 0], [0, 11]], {withLabel: false});
        ...
        //Sliders
        var slidery = brd1.create('slider',[[-1.5,2.0],[-1.5,8],[-1.5,0,1.5]],{withLabel:false,snapWidth:0.05,
                                                                               color:'Orange'});
        ...
        var d1B1 = brd1.create('point',[2.0,9.5],{visible:false});
        var d2B1 = brd1.create('point',[9.5,2.0],{visible:false});
        var pD1 = brd1.create('point',[d1B1,[sliderPositive]],{visible:false});
        var pD2 = brd1.create('point',[d2B1,[sliderPositive]],{visible:false});

        var D1fixed = brd1.create('segment',[d1B1,d2B1],{withLabel:false,fixed:true,'name':'D<sub>1</sub>',
                                                     highlight:false,dash:'1',strokeWidth:'3',
                                                     label:{offset:[90,-90]}});

        var D1 = brd1.create('segment',[pD1,pD2],{withLabel:true,highlight:false,'name':'M<sub>D2</sub>',
