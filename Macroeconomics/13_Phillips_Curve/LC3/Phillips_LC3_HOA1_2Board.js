var Macro = (function(JXG, MacroLib) {
  ...
  function init() {
    ...
    var S2B1 = MacroLib.createLine(brd1,{'ltype':'Supply','name':'SRAS<sub>2</sub>',color:'Lime'});
    ...
    //LRAS - fixed
    var LRAS = MacroLib.createLine(brd2,{'ltype':'Vertical','name':'LRPC','color':'DodgerBlue'})
