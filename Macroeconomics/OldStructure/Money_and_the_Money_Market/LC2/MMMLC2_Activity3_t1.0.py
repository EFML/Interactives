...
tmpfile = re.sub(r'src="MMMLC2_Activity3_t1.0.js"','src="/c4x/DavidsonCollege/DAP002/asset/MMMLC2_Activity3_t1.0.js"',tmpfile,flags=re.DOTALL)
tmpfile = re.sub(r'href="MMMLC2_Activity3_t1.0.css"','src="/c4x/DavidsonCollege/DAP002/asset/MMMLC2_Activity3_t1.0.css"',tmpfile,flags=re.DOTALL)

### Would be cool if it just took the title of the notebook
html_filename = 'MMMLC2_Activity3_t1.0' + '.html'
