...
# ###Fiscal Policy - LC1 HOA Expansionary Policy
...
tGen = templateGenerator.templateGenerator(course_id='DavidsonCollege/DAP002/3T2014',
                                           Title='Fiscal Policy - LC1 HOA Expansionary Policy',
                                           MacroJS='../../JS/Macro_1Board.js',
                                           JS='FP_LC1_HOA_Expansion.js',
                                           OutputFile='FP_LC1_HOA_Expansion.html',
                                           studioPaths=False 
                                          )
