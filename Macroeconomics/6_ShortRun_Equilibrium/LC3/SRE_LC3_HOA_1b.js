...
//Supply Line 1 - fixed
var SRAS1 = createLine(brd1,{'ltype':'Supply','name':'AS<sub>1924</sub>',color:'DodgerBlue'});
SRAS1.setAttribute({"dash":1,'fixed':true,'highlight':false});

//Demand Line 2 - moveable
var SRAS2 = createTransformLine(brd1,{'transformList':[sliderXPositive],'ltype':'Supply','name':'AS<sub>1929</sub>','color':'DodgerBlue'})
