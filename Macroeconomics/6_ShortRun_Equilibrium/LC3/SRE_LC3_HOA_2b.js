var Macro = (function(JXG, MacroLib) {
  ...
  function init() {
    ...
    //Supply Line 1 - fixed
    var SRAS1 = MacroLib.createLine(brd1,{'ltype':'Supply','name':'AS<sub>1973</sub>',color:'DodgerBlue'});
    SRAS1.setAttribute({"dash":1,'fixed':true,'highlight':false});

    //Demand Line 2 - moveable
    var SRAS2 = MacroLib.createTransformLine(brd1,{'transformList':[sliderXPositive],'ltype':'Supply','name':'AS<sub>1975</sub>','color':'DodgerBlue'})
