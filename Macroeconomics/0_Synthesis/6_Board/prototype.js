...
// BOARD 1
////////////
var brd1 = createBoard('jxgbox1',{bboxlimits:bboxlimits, xname:"Q Money", yname:"NIR"})

////////////
// BOARD 2
////////////
var brd2 = createBoard('jxgbox2',{bboxlimits:bboxlimits, xname:"Q Bonds per Period", yname:"Price<br>Bonds"})

////////////
// BOARD 3
////////////
var brd3 = createBoard('jxgbox3',{bboxlimits:bboxlimits})

////////////
// BOARD 4
////////////
var brd4 = createBoard('jxgbox4',{bboxlimits:bboxlimits})

////////////
// BOARD 5
////////////
var brd5 = createBoard('jxgbox5',{bboxlimits:bboxlimits})

////////////
// BOARD 5
////////////
var brd6 = createBoard('jxgbox6',{bboxlimits:bboxlimits})

//Sliders
var sliderx = brd1.create('slider',[[2.0,-1.25],[8,-1.25],[-1.5,0,1.5]],{withLabel:false,snapWidth:0.05,
                                                                         color:'Orange'});
...
////////////
//Demand Board 1
var D1 = createLine(brd1,{'ltype':'Demand','name':'M<sub>D</sub>',color:'DodgerBlue'});
//Supply Board 1
var S1 = createLine(brd1,{'ltype':'Vertical','name':'M<sub>S1</sub>',color:'Gray'});
S1.setAttribute({'fixed':true});

var S2 = createTransformLine(brd1,{'ltype':'Vertical','transform':sliderPositive,'name':'M<sub>S2</sub>',color:'DodgerBlue'});
...
var SB2 = createLine(brd2,{'ltype':'Supply','name':'S<sub>1</sub>',color:'Gray'});
//Supply Board 2
var D1B2 = createLine(brd2,{'ltype':'Demand','name':'D<sub>1</sub>',color:'Gray'});
...
////////////
//Demand Board 2 - with a Positive transformation
var SB3 = createLine(brd3,{'ltype':'Supply','name':'S<sub>1</sub>',color:'Gray'});
//Supply Board 2
var D1B3 = createLine(brd3,{'ltype':'Demand','name':'D<sub>1</sub>',color:'Gray'});
...
////////////
//Demand Board 2 - with a Positive transformation
var SB4 = createLine(brd4,{'ltype':'Supply','name':'S<sub>1</sub>',color:'Gray'});
//Supply Board 2
var D1B4 = createLine(brd4,{'ltype':'Vertical','name':'D<sub>1</sub>',color:'Gray'});
...
////////////
//Demand Board 1
var S5 = createLine(brd5,{'ltype':'Supply','name':'S',color:'DodgerBlue'});
//Supply Board 1
var D1B5 = createLine(brd5,{'ltype':'Demand','name':'D',color:'Gray'});
D1B5.setAttribute({'fixed':true});

var D2B5 = createTransformLine(brd5,{'ltype':'Demand','transform':sliderNegative,'name':'L<sub>2</sub>',color:'DodgerBlue'});

//Intersection of SD board 1
var iSDB = brd5.create('intersection',[D2B5,S5],{withLabel:false,highlight:false});
//var gSDB1 = brd1.create('glider',[3.75,7.75,S1],{withLabel:false,highlight:false});
...
////////////
//Demand Board 1
var S6 = createLine(brd6,{'ltype':'Supply','name':'S',color:'DodgerBlue'});
//Supply Board 1
var D1B6 = createLine(brd6,{'ltype':'Demand','name':'D',color:'Gray'});
D1B6.setAttribute({'fixed':true});

var D2B6 = createTransformLine(brd6,{'ltype':'Demand','transform':sliderPositive,'name':'L<sub>2</sub>',color:'DodgerBlue'});

//Intersection of SD board 1
var iSDB = brd6.create('intersection',[D2B6,S6],{withLabel:false,highlight:false});
//var gSDB1 = brd1.create('glider',[3.75,7.75,S1],{withLabel:false,highlight:false});
...
var dashB1fixed = createDashedLines2Axis(brd1,iSDB1,{fixed:true,withLabel:false,color:'Gray'});
var dashB1 = createDashedLines2Axis(brd1,iSDB1,{fixed:false,withLabel:true,color:'DodgerBlue',
