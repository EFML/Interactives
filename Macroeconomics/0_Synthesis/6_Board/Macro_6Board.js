...
createBoard = function(brdName,options) {
    ...
    var xlabel = board.create('text',[6,-0.5,xname],{fixed:true});
    var ylabel = board.create('text',[-2.45,10,yname],{fixed:true});
...
createTransformLine = function(board,options) {
    ...
    var pS1 = board.create('point',[s1B1,[transform]],{visible:false});
    var pS2 = board.create('point',[s2B1,[transform]],{visible:false});
