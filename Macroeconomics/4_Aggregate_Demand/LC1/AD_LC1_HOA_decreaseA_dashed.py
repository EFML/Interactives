...
tGen = templateGenerator.templateGenerator(course_id='DavidsonCollege/DAP002/3T2014',
                                           Title='Aggregate Demand: LC2 HOA #1b',
                                           MacroJS='../../JS/MacroAllBoards.js',
                                           JS='AD_LC1_HOA_AllAnimations_dashed.js',
                                           OutputFile='AD_LC1_HOA_decreaseA_dashed.html',
                                           studioPaths=False 
                                          )
