...
function init() {
    ...
    brd1 = createBoard('jxgbox1',{bboxlimits:bbox, xname:"Q Money", yname:"NIR"})

    ////////////
    // BOARD 2
    ////////////

    brd2 = createBoard('jxgbox2',{bboxlimits:bbox, xpos:[4,-1], xname:"Investment Demand", yname:"RIR"})

    ////////////
    // BOARD 3
    ////////////
    brd3 = createBoard('jxgbox3',{bboxlimits:bbox, xname:"RGDP", yname:"PL"})
