...
function init() {
    ...
    // BOARD 1
    ////////////
    brd1 = createBoard('jxgbox1',{xname:"Q Money", yname:"NIR"})

    ////////////
    // BOARD 2
    ////////////
    brd2 = createBoard('jxgbox2',{xpos:[4,-1], xname:"Investment Demand", yname:"RIR"})

    ////////////
    // BOARD 3
    ////////////
    brd3 = createBoard('jxgbox3',{xname:"RGDP", yname:"PL"})
