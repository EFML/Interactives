...
# ###Monetary Policy LC2 - 3 Board fixed (suggestion from Sally and Brian Held)
...
tGen = templateGenerator.templateGenerator(course_id='DavidsonCollege/DAP002/3T2014',
                                           ...
                                           JS='MP_LC2_3Board_fixed.js',
                                           OutputFile='MP_LC2_3Board_fixed.html',
                                           studioPaths=False 
                                          )
