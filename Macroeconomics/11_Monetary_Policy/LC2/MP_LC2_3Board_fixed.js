var Macro = (function(JXG, MacroLib) {
    ...
    function init() {
        ...
        // BOARD 1
        ////////////
        brd1 = MacroLib.createBoard('jxgbox1',{xname:"Q Money", yname:"NIR"})

        ////////////
        // BOARD 2
        ////////////
        brd2 = MacroLib.createBoard('jxgbox2',{xpos:[4,-1], xname:"Investment Demand", yname:"RIR"})

        ////////////
        // BOARD 3
        ////////////
        brd3 = MacroLib.createBoard('jxgbox3',{xname:"RGDP", yname:"PL"})

        //Sliders
        var sliderx = brd1.create('slider',[[0.0,-1.25],[0.01,-1.25],[-1.75,0,1.75]],{visible:false,withLabel:false,snapWidth:0.05,
                                                                                   snapWidth:1,color:'DodgerBlue'});
        ...
        var S2 = MacroLib.createTransformLine(brd1,{'ltype':'Vertical','transformList':[sliderPositive],'name':'S<sub>M2</sub>',color:'DodgerBlue'});
        ...
        var SB2 = MacroLib.createTransformLine(brd2,{'ltype':'Vertical','transformList':[sliderPositive],'name':'S<sub>1</sub>',color:'Gray'});
        ...
        var D2B3 = MacroLib.createTransformLine(brd3,{'ltype':'Demand','transformList':[sliderPositive],'name':'AD<sub>2</sub>',color:'DodgerBlue'});
