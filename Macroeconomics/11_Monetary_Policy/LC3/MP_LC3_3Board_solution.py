...
# ###Monetary Policy LC3 - 3 Board solution (suggestion from Sally and Brian Held)
# https://studio.edge.edx.org/container/i4x://DavidsonCollege/DAP002/vertical/5b75a21899ce463493de6c2824dfec1e?action=new
...
tGen = templateGenerator.templateGenerator(course_id='DavidsonCollege/DAP002/3T2014',
                                           ...
                                           JS='MP_LC3_3Board_solution.js',
                                           OutputFile='MP_LC3_3Board_solution.html',
                                           studioPaths=False 
                                          )
