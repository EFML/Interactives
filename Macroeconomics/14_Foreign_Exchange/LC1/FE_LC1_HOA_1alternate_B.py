...
tGen = templateGenerator.templateGenerator(course_id='DavidsonCollege/DAP002/3T2014',
                                           Title='Foreign Exchange: LC1 HOA #1b',
                                           MacroJS='../../JS/Macro_1Board.js',
                                           JS='FE_LC1_HOA_1alternate_B.js',
                                           OutputFile='FE_LC1_HOA_1alternate_B.html',
                                           studioPaths=False 
                                          )
