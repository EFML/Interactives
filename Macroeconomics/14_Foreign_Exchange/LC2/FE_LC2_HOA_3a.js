var Macro = (function(JXG, MacroLib) {
  ...
  function init() {
    ...
    brd1 = MacroLib.createBoard('jxgbox1',{xname:"Q of US Dollars", yname:"&pound;/$",
                                      grid:false,'xpos':[8,-0.5],bboxlimits:newBBox});

    //Sliders
    var sliderx1 = brd1.create('slider',[[3.5,-1.2],[8.5,-1.2],[0.0,0,2.0]],{withLabel:false,snapWidth:0.05,
                                                                           color:'DodgerBlue'});

    //Sliders
    var sliderx2 = brd1.create('slider',[[3.5,-2.0],[8.5,-2.0],[-2.0,0,0.0]],{withLabel:false,snapWidth:0.05,
                                                                           color:'Orange'});
    ...
    var AD2 = MacroLib.createTransformLine(brd1,{'transformList':[sliderX2Positive],ltype:'Demand',name:'$D<sub>2</sub>',color:'Orange'});
