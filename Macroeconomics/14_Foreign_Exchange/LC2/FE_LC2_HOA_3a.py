...
# ###Foreign Exchange- LC2 HOA 3a
# https://studio.edge.edx.org/container/i4x://DavidsonCollege/DAP002/vertical/0162c1e75813403b9df7efe4cf3d14f7
...
tGen = templateGenerator.templateGenerator(course_id='DavidsonCollege/DAP002/3T2014',
                                           Title='Foreign Exchange: LC3 HOA #1a',
                                           MacroJS='../../JS/Macro_1Board.js',
                                           JS='FE_LC2_HOA_3a.js',
                                           OutputFile='FE_LC2_HOA_3a.html',
                                           studioPaths=False 
                                          )
