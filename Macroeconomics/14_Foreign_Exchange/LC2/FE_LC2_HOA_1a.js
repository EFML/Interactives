var Macro = (function(JXG) {
  ...
  function init() {
    ...
    brd1 = createBoard('jxgbox1',{xname:"Q of US Dollars", yname:"&pound;/$",
    ...
    var SRAS2 = createTransformLine(brd1,{'transformList':[sliderXPositive],ltype:'Supply',name:'$S<sub>2</sub>',color:'DodgerBlue'});
