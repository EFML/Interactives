var Macro = (function(JXG, MacroLib) {
  ...
  function init() {
    ...
    //Sliders
    var sliderx = brd1.create('slider',[[3.5,-1.2],[8.5,-1.2],[0.0,0,2.0]],{withLabel:false,snapWidth:0.05,
                                                                           color:'DodgerBlue'});
    ...
    var SRAS2 = MacroLib.createTransformLine(brd1,{'transformList':[sliderXPositive],ltype:'Supply',name:'$S<sub>2</sub>',color:'DodgerBlue'});
