var Macro = (function(JXG, MacroLib) {
    ...
    function getGrade() { // Was called getInput
        state = {
            "dragLine": {
                'p1X': dragLine.point1.X(),
                'p2X': dragLine.point2.X(),
                'p1Y': dragLine.point1.Y(),
                'p2Y': dragLine.point2.Y()
            },
            "staticLine": {
                'p1X': staticLine.point1.X(),
                'p2X': staticLine.point2.X(),
                'p1Y': staticLine.point1.Y(),
                'p2Y': staticLine.point2.Y()
            }
        };
