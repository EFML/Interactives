...
var ipX0, ipV0, ipA;                                       // Eingabefelder (Anfangsposition, Anfangsgeschwindigkeit, Beschleunigung)
...
function start () {
  ...
  bu1 = document.getElementById("bu1");                    // Schaltknopf Reset
  bu2 = document.getElementById("bu2");                    // Schaltknopf Start/Pause/Weiter
  bu2.state = 0;                                           // Anfangszustand des Schaltknopfs
  cbSlow = document.getElementById("cbSlow");              // Optionsfeld Zeitlupe
  cbSlow.checked = false;                                  // Option Zeitlupe abgeschaltet
  ipX0 = document.getElementById("ipx0");                  // Eingabefeld Anfangsposition
  ipV0 = document.getElementById("ipv0");                  // Eingabefeld Anfangsgeschwindigkeit
  ipA = document.getElementById("ipa");                    // Eingabefeld Beschleunigung
  rbV = document.getElementById("rbv");                    // Radiobutton Geschwindigkeitsvektor
  rbV.checked = true;                                      // Radiobutton ausgewählt
  rbA = document.getElementById("rba");                    // Radiobutton Beschleunigungsvektor
...
function setButton2State (st) {
  ...
  bu2.innerHTML = text01[st];                              // Text aktualisieren
  }
...
function street () {
  ...
  alignText(text03,xx,yy+25,1);                            // Angabe der Einheit (m)
...
function cosy (x, y, yMinus, yPlus) {
  ...
  alignText(text02,x+105,y+25,1);                          // Beschriftung (Einheit s)
  }
...
function diagramTimePosition () {
  ...
  alignText(text03,xU-20,yU-135,1);                        // Angabe der Einheit (m)
...
function diagramTimeVelocity () {
  ...
  alignText(text04,xU-25,yU-75,1);                         // Angabe der Einheit (m/s)
...
function diagramTimeAcceleration () {
  ...
  alignText(text05,xU-27,yU-75,1);                         // Angabe der Einheit (m/s²)
