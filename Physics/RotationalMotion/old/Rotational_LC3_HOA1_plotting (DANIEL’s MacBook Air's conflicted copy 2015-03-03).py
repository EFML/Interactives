...
html_doc = """
    <html>
        ...
        <body>
            ...
            <input class="btn" type="button" value="Plot Data" onClick="setState(plotData())">
...
jscript = """
    ...
    var ylabel1 = brd1.create('text',[-1.2,10,"Torque<br>T*D"],{fixed:true});
    var xlabel1 = brd1.create('text',[9,-0.5,"Mass, M"],{fixed:true});
