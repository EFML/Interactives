var Macro = (function(JXG, MacroLib) {
    'use strict';
    var board, supplyLine1, supplyLine2, glider1, glider2, dashes1, dashes2;
    ...
    /////////////////////////
    var increaseQSBtn = document.getElementById('increaseQSBtn');
    var decreaseQSBtn = document.getElementById('decreaseQSBtn');
    ...
    //Interactivity
    if (increaseQSBtn) {
        increaseQSBtn.addEventListener('click', increaseQS);
    }
    if (decreaseQSBtn) {
        decreaseQSBtn.addEventListener('click', decreaseQS);
    }
    ...
    function decreaseQS() {
        var destPoint = board.create('point', [3.75, 3.75], {
            visible: false
        });
        resetAnimation();
        movePoint(glider1, destPoint)
